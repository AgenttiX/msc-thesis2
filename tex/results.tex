...
The solid black curves are the shock velocities $v_{sh}(c_{s,s})$ that are determined by $c_{s,s}$.
...
It also affects the ODE group of eq. \eqref{eq:hydro_param1}, \eqref{eq:hydro_param2}, \eqref{eq:hydro_param13} and therefore the shape of the fluid shell in front of the bubble wall.
