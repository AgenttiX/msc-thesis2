...
\begin{figure}[ht!]
\centering
\includegraphics[width=\textwidth]{fig/const_cs_gw_v}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=\textwidth]{fig/const_cs_gw}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=\textwidth]{fig/const_cs_gw_omgw0}
...
These differences in the shapes of the fluid shells carry over to the gravitational wave spectra of fig.~\ref{fig:gw_spectra}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=\textwidth]{fig/giese_lisa_fig2_alpha_n}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=\textwidth]{fig/giese_lisa_fig2_alpha_n_diff}
...
For $c_{s,s}=\frac{1}{4}, \ c_{s,b}=\frac{1}{3}$ and $\alpha_n = 0.01, \ 0.03$, there is no curve,
