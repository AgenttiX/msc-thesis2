...
\begin{equation}
\delta p_- \left(1 - \frac{v_+ v_-}{c_{s,b}^2} \right) = v_+ v_- De_+ - Dp_+
\end{equation}
...
\frac{v_+}{v_-}
&\approx \frac{
w_+ \left( \frac{v_+ v_-}{c_{s,b}^2} - 1 \right) + \left( De_+ - \frac{Dp_+}{c_{s,b}^2} \right)
}{
w_+ \left( \frac{v_+ v_-}{c_{s,b}^2} - 1 \right) + v_+ v_- \left( De_+ - \frac{Dp_+}{c_{s,b}^2} \right)
} \\
&= \frac{ \left( \frac{v_+ v_-}{c_{s,b}^2} - 1 \right) + 3 \alpha_{\bar{\theta}}
}{
\left( \frac{v_+ v_-}{c_{s,b}^2} - 1 \right) + 3v_+ v_- \alpha_{\bar{\theta}}}
\end{align}
