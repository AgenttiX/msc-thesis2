...
$T >> \mu$,
which means that can neglect $dN$.
...
\end{equation}
The total energy-momentum is conserved, and eq. \ref{eq:ep_conservation} can therefore be decomposed as
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.6\textwidth]{msc2-python/fig/potential.eps}
...
At the critical temperature $T_c$ of a phase transition the pressures on both sides of the wall are equal
\begin{equation}
p_+(T_c) = p_-(T_c),
