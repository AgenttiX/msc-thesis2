...
\begin{frame}
    ...
    \begin{column}{0.35\textwidth}
        \includegraphics[width=\textwidth]{../msc2-python/fig/entropy_bag}
    \end{column}
    \begin{column}{0.35\textwidth}
        \includegraphics[width=\textwidth]{../msc2-python/fig/entropy_const_cs}
    \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
    \begin{column}{0.35\textwidth}
        \includegraphics[width=\textwidth]{../msc2-python/fig/kappa_bag}
    \end{column}
    \begin{column}{0.35\textwidth}
        \includegraphics[width=\textwidth]{../msc2-python/fig/kappa_const_cs}
    \end{column}
    \end{columns}
\end{frame}
