...
\begin{frame}
    ...
    \begin{column}{0.35\textwidth}
        \includegraphics[width=\textwidth]{../fig/tampere/entropy_bag}
    \end{column}
    \begin{column}{0.35\textwidth}
        \includegraphics[width=\textwidth]{../fig/tampere/entropy_const_cs}
    \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
    \begin{column}{0.35\textwidth}
        \includegraphics[width=\textwidth]{../fig/tampere/kappa_bag}
    \end{column}
    \begin{column}{0.35\textwidth}
        \includegraphics[width=\textwidth]{../fig/tampere/kappa_const_cs}
    \end{column}
    \end{columns}
\end{frame}
