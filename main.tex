...
% Remember to update this to the pdf properties below as well!
...
\keywords{phase transitions, gravitational waves} % TODO
\depositeplace{}
...
\hypersetup{
    ...
    pdfkeywords={phase transitions} {gravitational waves} {LISA} {sound speed} {equation of state}, % list of keywords
...
% TODO: Remove this before submitting the thesis!
\listoftodos
\clearpage
